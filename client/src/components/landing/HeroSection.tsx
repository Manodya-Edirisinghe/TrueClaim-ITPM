  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-20 md:pt-40 md:pb-28">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div
          className="absolute left-1/2 top-0 h-[600px] w-[800px] -translate-x-1/2 rounded-full opacity-30"
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid items-center gap-12 text-center lg:grid-cols-2 lg:text-left">
          <div className="flex flex-col items-start lg:max-w-xl lg:pr-6">
            <AnimatedGroup variants={transitionVariants}>
              {/* Badge */}
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-500/25 bg-blue-500/10 px-4 py-1.5 text-xs font-medium text-blue-300">
        ...
        >
          <Link
            ...
            className="rounded-xl bg-[#0A66C2] px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 transition duration-200 hover:scale-105 hover:bg-[#0958a8] hover:shadow-blue-500/40"
          >
            Report Lost Item
          </Link>
          <Link
            href="/lostandfound?tab=found"
            className="rounded-xl border border-white/15 bg-white/5 px-7 py-3.5 text-sm font-semibold text-white transition duration-200 hover:scale-105 hover:bg-white/10 hover:shadow-white/10"
          >
            Report Found Item
          </Link>
          <Link
            href="/matching"
            className="flex items-center gap-2 rounded-xl border border-blue-500/25 bg-blue-500/10 px-7 py-3.5 text-sm font-semibold text-blue-300 transition duration-200 hover:scale-105 hover:bg-blue-500/20 hover:shadow-blue-500/20"
          >
